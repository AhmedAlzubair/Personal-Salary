...
class Utils {
  ...
  static void showSnackBar(String title, String message, Widget icon) {
    Get.showSnackbar(GetSnackBar(
      backgroundColor: AppColor.darkestBlue,
      title: title,
      isDismissible: true,
  ...
  List<Color> colors = [
    AppColor.lightBlue,
    AppColor.lightAccentBlue,
    AppColor.darkAccentBlue,
    AppColor.darkOrange,
  ...
  static Future<bool> showWarningDialog(BuildContext context, String title,
      String msg, String button, VoidCallback onConfirm) async {
